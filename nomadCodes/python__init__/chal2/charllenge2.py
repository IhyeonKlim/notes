...
#  tpye(a_dict) is not dict
  if type_of != type({}):
    ...
    if word in my_english_dict:
      print(word + " is already on the dictionary. Won't add")
      return
    else:
      my_english_dict[word] = definition
      print(word + ' has been added.')

def get_from_dict(my_english_dict, word=""):
  type_of = type(my_english_dict) 
...
def update_word(my_english_dict, word="", definition=""):
  ...
  elif word in my_english_dict:
    my_english_dict[word] = definition
  else :
    print(word + " is not on the dict. Can't update non-existing word.")

def delete_from_dict(my_english_dict, word=""):
  type_of = type(my_english_dict) 
  ...
  if type_of != type({}):
    ...
    print(word + " is not in this dict. Won't delete.")
